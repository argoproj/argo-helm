...
name: {{ default "argo-cd-redis" .Values.externalRedis.existingSecret }}
key: redis-username
...
name: "argo-cd-redis" # hard-coded in Job command and embedded Redis deployments (standalone and redis-ha)
key: auth
