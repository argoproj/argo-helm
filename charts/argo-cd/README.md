...
| repoServer.autoscaling.behavior | object	 | `{}` | Behavior of Horizontal Pod Autoscaler ([HPA]) for the repo server |
...
| server.autoscaling.behavior | object	 | `{}` | Behavior of Horizontal Pod Autoscaler ([HPA]) for the Argo CD server |
