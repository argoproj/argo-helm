...
| controller.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by application controller |
...
| repoServer.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by repo server |
...
| server.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by ArgoCD Server |
...
| dex.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by Dex server |
...
| redis.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by redis |
...
| applicationSet.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by ApplicationSet controller |
...
| notifications.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by notifications controller |
...
| commitServer.networkPolicy | object | `{}` (defaults to global.networkPolicy.create) | Default network policy rules used by commit server |
