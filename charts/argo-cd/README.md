...
### 5.32.0
This version changed supported Kubernetes version from `>=1.22.0-0` to `>=1.24.0-0`.

Please see more information about EoL: [Kubernetes EoL][k8s EoL].
...
[k8s EoL]: https://endoflife.date/kubernetes
