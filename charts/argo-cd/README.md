...
Starting from ArgoCD 3.0, the logs RBAC is enforced by default and the existing flag `server.rbac.log.enforce.enable` has been removed.
- [Logs RBAC enforcement as a first-class citizen from ArgoCD 3.0]
...
[Logs RBAC enforcement as a first-class citizen from ArgoCD 3.0]: https://argo-cd.readthedocs.io/en/stable/operator-manual/upgrading/2.14-3.0/#logs-rbac-enforcement-as-a-first-class-rbac-citizen