...
| controller.image.digest | string | `""` | Image Digest for the workflow controller |
...
| executor.image.digest | string | `""` | Image Digest for the Workflow Executors |
...
| server.image.digest | string | `""` | Image Digest for the server |
