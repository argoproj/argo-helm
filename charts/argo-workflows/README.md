...
| controller.metricsConfig.metricsTTL | string | `"0"` | How often custom metrics are cleared from memory |
...
| controller.telemetryConfig.metricsTTL | string | `"0"` | How often custom metrics are cleared from memory |
