...
| apiVersionOverrides | object | `{"ingress":""}` | Override APIVersions If you want to template helm charts but cannot access k8s API server you can set api versions here |
...
| webhook | object | `{"ingress":{"annotations":{},"enabled":false,"extraPaths":[],"hosts":[],"ingressClassName":"","labels":{},"pathType":"Prefix","paths":["/api/webhook"],"tls":[]}}` | [Webhook for the Git Generator](https://argocd-applicationset.readthedocs.io/en/master/Generators-Git/#webhook-configuration) |
